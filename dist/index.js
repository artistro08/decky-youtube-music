    ...
    return (SP_JSX.jsx(Section, { children: queue.map((item, index) => {
            ...
            if (DFL.DialogButton) {
                return (SP_JSX.jsxs(DFL.Focusable, { style: { display: 'flex', alignItems: 'stretch', marginTop: '2px', marginBottom: '2px' }, "flow-children": "horizontal", children: [SP_JSX.jsxs(DFL.DialogButton, { className: isSelected ? 'yt-queue-active' : undefined, style: {
                                ...
                                justifyContent: 'center',
                                borderRadius: '0',
                            }, onClick: () => { void handleJump(index); }, children: [SP_JSX.jsxs("div", { style: { fontWeight: isSelected ? 'bold' : 'normal', fontSize: '13px', display: 'flex', alignItems: 'center' }, children: [SP_JSX.jsx(IoPlay, { size: 11, style: { marginRight: '6px', flexShrink: 0, visibility: isSelected ? 'visible' : 'hidden' } }), SP_JSX.jsx("span", { style: { overflow: 'hidden', whiteSpace: 'nowrap', maskImage: 'linear-gradient(to right, black calc(100% - 24px), transparent 100%)' }, children: title })] }), artist && (SP_JSX.jsx("div", { style: { fontSize: '11px', color: 'var(--gpSystemLighterGrey)', marginTop: '2px' }, children: artist }))] }), SP_JSX.jsx(DFL.DialogButton, { className: isSelected ? 'yt-queue-active' : undefined, onClick: () => { void handleRemove(index); }, style: {
                                width: '36px',
                                minWidth: '0',
                                padding: '0',
                                marginLeft: '0',
