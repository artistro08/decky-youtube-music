...
const Section = ({ title, children }) => (SP_JSX.jsxs("div", { children: [title && (SP_JSX.jsx("div", { style: {
...
const PlayerView = () => {
    ...
    return (SP_JSX.jsxs(SP_JSX.Fragment, { children: [albumArt && (SP_JSX.jsx(Section, { children: SP_JSX.jsx("div", { style: { padding: '0 12px' }, children: SP_JSX.jsx("div", { style: { display: 'flex', justifyContent: 'center', padding: '8px 0' }, children: SP_JSX.jsx("img", { src: albumArt, alt: "Album art", style: { width: '100%', maxWidth: '180px', borderRadius: '8px' } }) }) }) })), SP_JSX.jsxs(Section, { children: [SP_JSX.jsx("div", { style: { padding: '0 12px' }, children: SP_JSX.jsxs("div", { style: { textAlign: 'center', padding: '8px 0' }, children: [SP_JSX.jsx("div", { style: { fontWeight: 'bold', fontSize: '13px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }, children: title }), artist && (SP_JSX.jsx("div", { style: { fontSize: '11px', color: 'var(--gpSystemLighterGrey)', marginTop: '2px' }, children: artist }))] }) }), duration > 0 && (SP_JSX.jsx("div", { style: { padding: '0 12px' }, children: SP_JSX.jsx(DFL.SliderField, { label: "", value: position, min: 0, max: duration, step: 1, onChange: (val) => { void seekTo(val); }, showValue: false }) }))] }), SP_JSX.jsx(Section, { title: "Controls", children: DFL.DialogButton ? (SP_JSX.jsxs(SP_JSX.Fragment, { children: [SP_JSX.jsxs(DFL.Focusable, { style: { display: 'flex', marginTop: '4px', marginBottom: '4px' }, "flow-children": "horizontal", children: [SP_JSX.jsx(DFL.DialogButton, { style: rowBtnFirst, onClick: () => { void previous(); }, children: "\u23EE" }), SP_JSX.jsx(DFL.DialogButton, { style: rowBtn, onClick: () => { void togglePlay(); }, children: isPlaying ? '⏸' : '▶' }), SP_JSX.jsx(DFL.DialogButton, { style: rowBtn, onClick: () => { void next(); }, children: "\u23ED" })] }), SP_JSX.jsxs(DFL.Focusable, { style: { display: 'flex', marginTop: '4px', marginBottom: '4px' }, "flow-children": "horizontal", children: [SP_JSX.jsx(DFL.DialogButton, { style: rowBtnFirst, onClick: () => { void like(); }, children: "\uD83D\uDC4D Like" }), SP_JSX.jsx(DFL.DialogButton, { style: rowBtn, onClick: () => { void dislike(); }, children: "\uD83D\uDC4E Dislike" })] })] })) : (SP_JSX.jsxs(SP_JSX.Fragment, { children: [SP_JSX.jsx(DFL.ButtonItem, { onClick: () => { void previous(); }, children: "\u23EE Previous" }), SP_JSX.jsx(DFL.ButtonItem, { onClick: () => { void togglePlay(); }, children: isPlaying ? '⏸ Pause' : '▶ Play' }), SP_JSX.jsx(DFL.ButtonItem, { onClick: () => { void next(); }, children: "\u23ED Next" }), SP_JSX.jsx(DFL.ButtonItem, { onClick: () => { void like(); }, children: "\uD83D\uDC4D Like" }), SP_JSX.jsx(DFL.ButtonItem, { onClick: () => { void dislike(); }, children: "\uD83D\uDC4E Dislike" })] })) }), SP_JSX.jsxs(Section, { title: "Volume", children: [SP_JSX.jsx("div", { style: { padding: '0 12px' }, children: SP_JSX.jsx(DFL.SliderField, { label: muted ? 'Muted' : `${Math.round(volume)}%`, value: muted ? 0 : volume, min: 0, max: 100, step: 1, onChange: (val) => { void setVolume(val); }, showValue: false }) }), SP_JSX.jsx("div", { style: { padding: '0 12px' }, children: SP_JSX.jsx(DFL.ButtonItem, { onClick: () => { void toggleMute(); }, children: muted ? '🔇 Unmute' : '🔊 Mute' }) })] }), SP_JSX.jsxs(Section, { title: "Playback", children: [SP_JSX.jsx("div", { style: { padding: '0 12px' }, children: SP_JSX.jsx(DFL.ToggleField, { label: "Shuffle", checked: isShuffled, onChange: () => { void shuffle(); } }) }), SP_JSX.jsx("div", { style: { padding: '0 12px' }, children: SP_JSX.jsx(DFL.ButtonItem, { onClick: () => { void switchRepeat(REPEAT_NEXT[repeat] ?? 1); }, children: REPEAT_LABELS[repeat] ?? 'Repeat: Off' }) })] })] }));
};
...
const QueueView = () => {
    ...
    if (loading) {
        return (SP_JSX.jsx(Section, { children: SP_JSX.jsx("div", { style: { padding: '0 12px' }, children: SP_JSX.jsx("div", { style: { padding: '16px 0', color: 'var(--gpSystemLighterGrey)', fontSize: '12px' }, children: "Loading queue..." }) }) }));
    }
    if (queue.length === 0) {
        return (SP_JSX.jsx(Section, { title: "Queue", children: SP_JSX.jsx("div", { style: { padding: '0 12px' }, children: SP_JSX.jsx("div", { style: { padding: '8px 0', color: 'var(--gpSystemLighterGrey)', fontSize: '12px' }, children: "Queue is empty" }) }) }));
    }
    return (SP_JSX.jsxs(Section, { title: "Queue", children: [SP_JSX.jsx("div", { style: { padding: '0 12px' }, children: SP_JSX.jsx(DFL.ButtonItem, { onClick: () => { void handleClear(); }, children: "Clear Queue" }) }), queue.map((item, index) => {
...
const TabsContainer = () => {
    ...
    SP_REACT.useEffect(() => {
        ...
        let padEl = containerRef.current.parentElement;
