...
const Section = ({ title, children }) => (SP_JSX.jsxs("div", { style: { padding: '0 12px' }, children: [title && (SP_JSX.jsx("div", { style: {
                padding: '12px 0 4px',
                fontSize: '11px',
                fontWeight: 'bold',
...
const QueueView = () => {
    ...
    if (loading) {
        return (SP_JSX.jsx(Section, { children: SP_JSX.jsx("div", { style: { padding: '16px 0', color: 'var(--gpSystemLighterGrey)', fontSize: '12px' }, children: "Loading queue..." }) }));
    }
    if (queue.length === 0) {
        return (SP_JSX.jsx(Section, { title: "Queue", children: SP_JSX.jsx("div", { style: { padding: '8px 0', color: 'var(--gpSystemLighterGrey)', fontSize: '12px' }, children: "Queue is empty" }) }));
    }
